...
function adjustHue(degree, color) {
  var normalizedColor = nameToHex(color);
  var hslColor = parseToHsl(normalizedColor);
...
function invert(color) {
  ...
  var value = parseToRgb(normalizedColor);
...
function mix() {
  ...
  var normalizedColor1 = nameToHex(color);
  var parsedColor1 = parseToRgb(normalizedColor1);
  var color1 = _extends({}, parsedColor1, {
    alpha: typeof parsedColor1.alpha === 'number' ? parsedColor1.alpha : 1
  });

  var normalizedColor2 = nameToHex(color);
  var parsedColor2 = parseToRgb(normalizedColor2);
...
function opacify(amount, color) {
  var normalizedColor = nameToHex(color);
  var parsedColor = parseToRgb(normalizedColor);
